...
pub fn Timer() -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                class: "transition duration-200 absolute top-0 left-0 w-full h-full opacity-10 rounded-lg bg-transparent hover:bg-gray-500 z-10 cursor-pointer flex items-center justify-center",
            ...
            Icon {
                ...
                class: "transition duration-200 absolute",
